...
(function initContactForm(){
  ...
  form.addEventListener("submit", (e)=>{
    ...
    if (!form.checkValidity()){
      setStatus("กรุณากรอกข้อมูลให้ครบถ้วนและถูกต้อง");
      form.reportValidity();
      return;
    }
    ...
    if (!name || !email || !subject || !message || !topic || !consent){
      setStatus("ข้อมูลไม่ถูกต้องหรือมีอักขระไม่เหมาะสม"); return;
    }
    ...
    setStatus("ส่งข้อความสำเร็จ (บันทึกในอุปกรณ์นี้เพื่อการทดสอบ)", true);
    form.reset();
  });
})();
